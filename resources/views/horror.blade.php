...
<body class="text-center">
  ...
  <div class="cover-container d-flex h-100 p-3 mx-auto flex-column">
    ...
    <main role="main" class="inner cover">
      <h1 class="cover-heading">Horror</h1>
      <img src="{{ asset('images/horror.jpg') }}" alt="Thumbnail [100%x225]" style="height: 300px; width: 100%; display: block; object-fit:contain;">
      <br>
      <p class="lead">Film horor adalah sebuah genre film yang berusaha untuk memancing emosi berupa ketakutan atau rasa jijik dari penontonnya. Alur cerita mereka sering melibatkan tema-tema kematian, supranatural, atau penyakit mental. Banyak cerita film horor yang berpusat pada sebuah tokoh antagonis tertentu yang jahat.
        <br><br>
